            ...
            <div className="Cookie">
                ...
                <div className="container">
                    <div className="main__content">
                        ...
                        <p className="main__content__paragraph franklin">If you have any questions, please contact us by email at privacy@nytimes.com. You can also write to us: The New York Times Company, 620 Eighth Avenue, New York, N.Y. 10018, attn.: Privacy Counsel.</p>
                    </div>
                </div>
                </section>
