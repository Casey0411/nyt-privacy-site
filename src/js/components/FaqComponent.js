...
function FaqComponent() {
    ...
    return (
        ...
        <div className="FaqComponent" id="faqComponent">
            <section className="faq-section" id="faq-section">
                <div className="container">
                    ...
                    <div className="faq-holder">
                        ...
                        <Accordion title="Why does The Times collect (and use) my data?" number="1" name="privacyfaq">
                        ...
                        <Accordion title="What type of data is collected about me when I’m accessing The Times?" number="2" name="privacyfaq">
                        ...
                        <Accordion title="What does The Times do with data it collects on me?" number="3" name="privacyfaq">
                        ...
                        <Accordion title="How are you keeping my data safe?" number="4" name="privacyfaq">
                        ...
                        <Accordion title="What are some ways I can protect my data?" number="5" name="privacyfaq">
                        ...
                        <Accordion title="Why am I given the option to use Facebook and Google for log-in?" number="6" name="privacyfaq">
                        ...
                        <Accordion title="How can I learn more about how companies use personal data online?" number="7" name="privacyfaq">
