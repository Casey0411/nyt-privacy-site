            ...
            <section className="faq-section" id="faq-section">
                <div className="container">
                    ...
                    <div className="faq-holder">
                        ...
                        <Accordion title="How are you keeping my data safe?" number="3">
                        ...
                        <Accordion title="What are some ways I can protect my data?" number="4">
                        ...
                        <Accordion title="Why am I given the option to use Facebook and Google for log-in?" number="5">
